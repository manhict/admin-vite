...
const handleCreateOrUpdate = () => {
  formRef.value?.validate((valid: boolean, fields) => {
    if (!valid) return console.error("Form check cannot be passed", fields)
    loading.value = true
...
const handleDelete = (row: GetTableData) => {
  ElMessageBox.confirm(`User is being deleted:${row.username},confirm deletion?`, "hint", {
...
<template>
  <div class="app-container">
    <el-card v-loading="loading" shadow="never" class="search-wrapper">
      <el-form ref="searchFormRef" :inline="true" :model="searchData">
        ...
        <el-form-item>
          ...
          <el-button :icon="Refresh" @click="resetSearch">Repossess</el-button>
        </el-form-item>
      </el-form>
    </el-card>
      ...
      <div class="table-wrapper">
        <el-table :data="tableData">
          ...
          <el-table-column prop="status" label="State" align="center">
            <template #default="scope">
              <el-tag v-if="scope.row.status" type="success" effect="plain">Open up</el-tag>
    ...
    <el-dialog
      ...
      :title="formData.id === undefined ? 'New users' : 'Modify the user'"
      @closed="resetForm"
      width="30%"
    >
